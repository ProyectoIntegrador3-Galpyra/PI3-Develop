...
@pytest.mark.asyncio
async def test_crud_galpones(client, seeded_admin):
    ...
    list_response = await client.get("/api/galpones")
    ...
    delete_response = await client.delete(f"/api/galpones/{galpon_id}")
